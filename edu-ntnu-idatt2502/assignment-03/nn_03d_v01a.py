# Assignment 03, exercise c, Fashion MNIST
...
x_train = mnist_train_fashion.data.reshape(-1, 1, 28, 28).float()  # torch.functional.nn.conv2d argument must include channels (1)
...
x_test = mnist_test_fashion.data.reshape(-1, 1, 28, 28).float()  # torch.functional.nn.conv2d argument must include channels (1)
...
# Model: A
# Epochs: 20
# Accuracy for FashionMNIST: 89,95%